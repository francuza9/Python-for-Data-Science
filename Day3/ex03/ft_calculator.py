class calculator:
	...
	Attributes:
		values (list of float | int): The list of numerical values to operate on.
	"""
	...
	def __init__(self, values: list[float | int]):
		...
		for value in values:
			if not isinstance(value, (int, float)):
				raise TypeError("All elements in values must be integers or floats")
		self.values = values

	def __add__(self, object) -> None:
		""" Add a number to each element in the values list and print the result.
	...
	def __mul__(self, object) -> None:
		""" Multiply each element in the values list by a number and print the result.
	...
	def __sub__(self, object) -> None:
		""" Subtract a number from each element in the values list and print the result.
	...
	def __truediv__(self, object) -> None:
		""" Divide each element in the values list by a number and print the result.
